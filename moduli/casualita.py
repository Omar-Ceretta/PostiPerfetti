...
def descrivi_seed(seed_principale: int, modalita: str, contesto: dict | None = None) -> str:
    """Riga breve e leggibile per log e diagnostica."""
    parti = [f"seed principale={seed_principale}", f"modalità={modalita}"]
    for chiave, valore in (contesto or {}).items():
