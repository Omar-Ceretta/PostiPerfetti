...
> [!IMPORTANT]
>
> ✅ **«PostiPerfetti» è un programma gratuito e *open source* che utilizza un originale algoritmo per aiutare il docente Coordinatore (o qualsiasi insegnante ne abbia la necessità) ad assegnare agli studenti il proprio posto in classe.** 
>
...
>
> 🔐 **«PostiPerfetti» lavora in locale e non invia dati a servizi remoti**. Le operazioni di installazione e aggiornamento usano la rete solo per scaricare il programma e le sue dipendenze.
...
> È l'ideale per rendersi conto di come i vincoli impostati si traducano concretamente in assegnazioni, e ti consentirà di capire in maniera pragmatica come l'algoritmo, con la progressiva crescita delle assegnazioni salvate, metta in pratica la sua logica "flessibile". In questi primi approcci a «PostiPerfetti» imparerai il modo migliore per modificare i vincoli (diminuendone o aumentandone l'intensità) affinché il risultato rispecchi al meglio i tuoi desiderata.
>
...
[![Aula di PostiPerfetti - tema scuro](documentazione/immagini/aula_scuro.png)](documentazione/immagini/aula_scuro.png)

[![Aula di PostiPerfetti - tema chiaro](documentazione/immagini/aula_chiaro.png)](documentazione/immagini/aula_chiaro.png)
...
| ⌛ Generazione annuale soltanto "parziale"                            | Significa che **è stato raggiunto il limite massimo, ossia 10 MINUTI**, prima che l'algoritmo riuscisse a completare tutti i mesi. Dopo aver salvato quelli ottenuti, puoi generare i rimanenti attraverso un'altra assegnazione. |
