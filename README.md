...
>
> ✅ Per funzionare, esso **richiede la creazione di un semplice file di testo con i dati essenziali degli alunni**: *cognome*, *nome*, *genere*. Tramite alcune funzioni intuitive sarà poi possibile aggiungere agli allievi una serie di informazioni e vincoli ("affinità" e "incompatibilità" fra studenti, loro "posizione" rispetto alla cattedra, eventuale preferenza per "coppie miste maschio + femmina") per ottenerne **una assegnazione quanto più in linea con i desiderata dell'insegnante**.
>
