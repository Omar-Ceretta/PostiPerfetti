...
«PostiPerfetti» supporta le principali distribuzioni delle famiglie **Debian/Ubuntu, Fedora, Arch Linux e openSUSE**. È stato testato su Debian 13.6, Ubuntu 26.04 (e le sue derivate Linux Mint 22.3 e Zorin OS 18.1), Fedora 44, Arch Linux e openSUSE Leap 16. Il codice dell'installer viene verificato automaticamente su Ubuntu 24.04, Fedora 44, Arch Linux e openSUSE Tumbleweed.
